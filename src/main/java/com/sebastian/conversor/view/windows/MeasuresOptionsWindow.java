...
public class MeasuresOptionsWindow extends JFrame {

    private JComboBox<String> conversionComboBox;
    private JTextField amountTextField;
    private JButton convertButton;

    public MeasuresOptionsWindow(String type) {
        ...
        conversionComboBox = new JComboBox<>(new String[]{"cmainch", "cmafeet", "kmamilla"});
